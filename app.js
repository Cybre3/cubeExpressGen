...
mongoose
  .connect(
    `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.g2ipk.mongodb.net/${process.env.DB_CLUSTER_NAME}?retryWrites=true&w=majority`,
    {
      dbName: process.env.DB_CLUSTER_NAME,
